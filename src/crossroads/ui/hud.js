...
export function createHUD(callbacks) {
  ...
  root.innerHTML = `
    <div id="topbar">
      ...
      <div class="tb-instruments">
        ...
        <div class="tb-clock-frame">
          <span class="tbc-tag" aria-hidden="true">1944 · 島區</span>
    ...
    <div id="legend">
      ...
      <span class="hint">藍線：衝鋒路線 · 藍錐：基底火力</span>
    ...
    <div id="intro">
      <div class="intro-box">
        ...
        <p class="intro-desc">
          ...
          10 月 5 日拂曉，溫斯特上尉以約 35 人反擊夜渡萊茵河、近 300 人的德軍：
    ...
    <div id="figure-card" class="hidden">
      <div class="figure-box">
        ...
        <div class="fig-result"><span class="rl">十字路口戰績</span><span id="fig-battle"></span></div>
  ...
  function rosterHtml(side) {
    ...
    const order = ['指揮官', '巡邏隊', '火力組', '突擊隊', '通信'];
