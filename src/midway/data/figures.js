...
// 史料依據:NHHC、Parshall & Tully《Shattered Sword》。avatar 取姓名首字作頭像。
export const figures = [
  // ── 日軍 指揮官 ──
  {
    id: 'yamamoto', side: 'red', type: 'commander', name: '山本五十六', nameEn: 'Isoroku Yamamoto', avatar: '山',
    rank: '海軍大將', affil: '聯合艦隊司令長官 · 旗艦大和', fate: '1943 年座機遭美軍伏擊陣亡',
  ...
  },
  {
    ...
    rank: '海軍中將', affil: '第一航空艦隊司令長官 · 旗艦赤城', fate: '1944 年塞班島戰役自盡',
  ...
  },
  {
    ...
    rank: '海軍少將', affil: '第二航空戰隊司令官 · 旗艦飛龍', fate: '與飛龍一同沉沒',
  ...
  // ── 美軍 指揮官 ──
  {
    ...
    rank: '海軍上將', affil: '太平洋艦隊總司令 · 珍珠港', fate: '戰後晉升五星上將',
  ...
  },
  {
    ...
    rank: '海軍少將', affil: '第 17 特遣艦隊司令 · 戰術總指揮', fate: '約克鎮號中彈後移交指揮權',
  ...
  },
  {
    ...
    rank: '海軍少將', affil: '第 16 特遣艦隊司令 · 旗艦企業號', fate: '戰後升任太平洋艦隊總司令',
  ...
  // ── 王牌飛行員 ──
  {
    ...
    rank: '海軍上尉', affil: 'VB-6 轟炸中隊長 · 企業號', fate: '吸入腐蝕氣體，中途島成最後一戰',
  ...
  },
  {
    ...
    rank: '海軍大尉', affil: '飛龍俯衝轟炸隊長', fate: '攻擊約克鎮號時戰死',
  ...
  },
  {
    ...
    rank: '海軍大尉', affil: '飛龍艦攻隊長', fate: '單程出擊，壯烈戰死',
  ...
  // ── 日軍 航艦艦長 ──
  {
    ...
    rank: '海軍大佐', affil: '赤城艦長', fate: '一度欲與艦同沉，被部下勸離',
  ...
  },
  {
    ...
    rank: '海軍大佐', affil: '加賀艦長', fate: '艦橋中彈，當場陣亡',
  ...
  // ── 美軍 航艦艦長 ──
  {
    ...
    rank: '海軍上校', affil: '企業號艦長', fate: '企業號全程未受損，戰後晉升將官',
  ...
  },
  {
    ...
    rank: '海軍上校', affil: '大黃蜂號艦長', fate: '日後成為快速航艦部隊名將',
  ...
  },
  {
    ...
    rank: '海軍上校', affil: '約克鎮號艦長', fate: '兩度搶救約克鎮號',
