...
export const units = [
  // 紅方 — 海上特攻隊(第二艦隊)
  {
    ...
    classLabel: '戰艦', weight: 6, length: 112,
    strength: { hull: 100 },
  ...
  },
  {
    ...
    classLabel: '輕巡', weight: 3, length: 74,
    strength: {},
  ...
  },
  {
    ...
    classLabel: '驅逐', weight: 1, length: 51,
    strength: {},
  ...
  // 藍方 — 美國海軍 第58特遣艦隊(在東南方海域,放飛艦載機;全程未受攻擊)
  {
    ...
    deckMark: '17', islandSide: 'right', weight: 2, length: 113,
  ...
  },
  {
    ...
    deckMark: '12', islandSide: 'right', weight: 2, length: 113,
  ...
  },
  {
    ...
    deckMark: '9', islandSide: 'right', weight: 2, length: 113,
  ...
  },
  {
    ...
    deckMark: '10', islandSide: 'right', weight: 2, length: 113,
    strength: { aircraft: 95 },
